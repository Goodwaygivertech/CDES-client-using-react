...
return toast.error("Please confirm the password!")
    ...
    try {
      ...
      if (responseData.created) {
        ...
        localStorage.setItem("userData", JSON.stringify({ created: true, data: { fname, lname, email, _id  } }));
        // navigate("/")
        setDoneSignUp(true)
  ...
  return (
   <>
 <Link to="/" className="flex items-center space-x-3 rtl:space-x-reverse py-4">
      <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTXQgUC93Ys3Fox4V5uUFUEai59O870QsUxlPTrRYcW-w&s" className="h-8 rounded-full" alt="Flowbite Logo" />
      <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">CGES</span>
  </Link>
  ...
  <div className="grid md:grid-cols-2 md:gap-6">
    <div className="relative z-0 w-full mb-5 group">
      <input
        type="text"
        name="fname" value={formData.fname} onChange={handleInputChange}
    ...
    <div className="relative z-0 w-full mb-5 group">
      <input
        type="text"
        name="lname" value={formData.lname} onChange={handleInputChange}
